...
export function TikTokCard({
    ...
    // Format: https://www.tiktok.com/@username/video/7582134869812120863
    ...
    const handlePlay = () => {
        if (videoId) {
            ...
            // Fallback if no video ID (maybe just open link outside but for now do nothing or log)
    ...
    return (
        <motion.div
            className="relative aspect-[9/16] rounded-xl overflow-hidden bg-zinc-900 group border border-white/5"
